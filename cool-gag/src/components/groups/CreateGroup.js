...
import {UserQuery} from '../../containers/UserQuery'
import {Button, ButtonGroup, Card, CardBlock, Col, Collapse, Container, FormGroup, Input, Row} from 'reactstrap';
...
import MyGroupsQuery from './MyGroupsList';
